  ...
  return (
    <>
      ...
      <header
        ...
        style={{ backgroundImage: 'url("/images/card-homebuyers.jpg")', backgroundSize: 'cover', backgroundPosition: 'center' }}
      >
      ...
      <section id="process" className="py-16">
        <div className="max-w-5xl mx-auto px-8">
          <div className="grid md:grid-cols-[1fr_260px] gap-10 items-start">
            ...
            {/* Sidebar */}
            <div className="md:sticky md:top-[160px] md:self-start flex flex-col gap-5">
